...
from .views import base_views, question_views, answer_views, comment_views, vote_view
...
urlpatterns = [
    ...
    path('vote/question/<int:question_id>/', vote_view.vote_question, name='vote_question'),
    path('vote/answer/<int:answer_id>/', vote_view.vote_answer, name='vote_answer'),
