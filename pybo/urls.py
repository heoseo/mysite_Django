...
from .views import base_views, question_views, answer_views, comment_views, votes_views
...
urlpatterns = [
    ...
    path('vote/question/<int:question_id>/', votes_views.vote_question, name='vote_question'),
    path('vote/answer/<int:answer_id>/', votes_views.vote_answer, name='vote_answer'),
